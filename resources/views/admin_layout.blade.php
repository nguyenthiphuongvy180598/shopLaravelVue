    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="/admin-page"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/get-category')}}">Add new Category Product</a></li>
						<li><a href="{{URL::to('/all-category')}}">Show all Category Prodcut</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/get-product')}}">Add new Product</a></li>
						<li><a href="{{URL::to('/all-product')}}">Show all Prodcut</a></li>
                    </ul>
                </li>
