                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{URL::to('/update-category/'.$edit_value->category_id)}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none"  rows="8" name="category_product_desc" class="form-control" id="exampleInputPassword1" placeholder="Description">{{$edit_value->category_desc}}</textarea>
                        </div>
